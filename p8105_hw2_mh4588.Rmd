...
bake_off_viewers = mutate(bake_off_viewers, episode = as.character(episode))
...
results_viewers <- left_join(bake_off_results, bake_off_viewers, by = c("episode","series"))
#Final dataset
bake_off <- left_join(bakers_and_bakes, results_viewers, by = c("episode","series", "baker"))
