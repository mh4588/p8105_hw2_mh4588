...
```
The average viewership in Season 1 was `r mean(pull(filter(bake_off_viewers, series=="1")), na.rm=TRUE)` while the average viewership in Season 5 was `r mean(pull(filter(bake_off_viewers, series=="5")), na.rm=TRUE)`. 